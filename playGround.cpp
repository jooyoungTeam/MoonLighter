...
void playGround::soundLoad()
{
	...
	// ==============================================샵 & NPC & 포션 샵==========================================
	SOUNDMANAGER->addSound("shop_door_open1", "sound/shopSound/문열림.wav", false, false);
	SOUNDMANAGER->addSound("shop_door_open2", "sound/shopSound/문열림2.wav", false, false);
	SOUNDMANAGER->addSound("shop_door_close", "sound/shopSound/문닫힘.wav", false, false);
	SOUNDMANAGER->addSound("shop_too_cheap", "sound/shopSound/엄청싸다.wav", false, false);
	SOUNDMANAGER->addSound("shop_cheap", "sound/shopSound/싸다.wav", false, false);
	SOUNDMANAGER->addSound("shop_too_expensive", "sound/shopSound/엄청비싸다.wav", false, false);
	SOUNDMANAGER->addSound("shop_expensive", "sound/shopSound/비싸다.wav", false, false);
	SOUNDMANAGER->addSound("shop_sell", "sound/shopSound/아이템팔림.wav", false, false);
